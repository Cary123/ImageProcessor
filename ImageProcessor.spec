...
a = Analysis(
    ...
    hiddenimports=[
        ...
        'image_processor.gui.panels.eraser_panel',
        'image_processor.gui.panels.interactive_tool_panel',
        'image_processor.gui.widgets.engine_workers',
        'image_processor.models.canvas_snapshot',
        'image_processor.gui.brush_modes',
