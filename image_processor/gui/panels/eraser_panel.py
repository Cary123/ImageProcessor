...
class EraserPanel(QWidget):
    """Dedicated panel for the eraser tool."""
    ...
    def _build_ui(self) -> None:
        ...
        hint = QLabel("在画布上涂抹以擦除透明度。完成后点击「应用」保留修改，或「取消」恢复原图。")
        hint.setWordWrap(True)
        hint.setStyleSheet(gallery_hint_stylesheet())
        self.hint_label = hint
        layout.addWidget(hint)

        size_label = QLabel("橡皮大小")
